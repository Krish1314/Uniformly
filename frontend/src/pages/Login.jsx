            ...
            <div className="mb-4">
              ...
              <div className="position-relative">
                <input 
                  ...
                  required 
                />
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye position-absolute text-muted" style={{ right: '14px', top: '14px', cursor: 'pointer' }} viewBox="0 0 16 16">
